...
<body style="font-family: Outfit, sans-serif;" <?php body_class(); ?>>
    ...
    $args = array(
        ...
        'post_status' => 'publish',
        'paged' => $paged,
        'tag_id' => $tag->term_id, // Ensure the query is limited to the current tag
    );
    ...
    <div class="container">
        <div class="row row-cols-1">
            ...
            <div class="col-lg-8 p-3">
                <!-- Tag Wise Posts -->
                <div class="content">
                    <h4 id="cat-tag-search-title">Selected Tag: <?php single_tag_title(); ?></h4>
                    ...
                    <?php else : ?>
                        <p><?php _e('Sorry, no posts found with this tag.', 'arunvvision'); ?></p>
                    <?php endif; ?>
