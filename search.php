    ...
    <div class="container">
        <div class="row row-cols-1">
            ...
            <div class="col-lg-8 p-3">
                <!-- Search Results -->
                <div class="content">
                    <h4 id="cat-tag-search-title"><?php printf(esc_html__('Search Results for: %s', 'arunvvision'), esc_html($search_query)); ?></h4>
                    ...
                    <?php else : ?>
                        <p><?php _e('Sorry, no results found for your search.', 'arunvvision'); ?></p>
                    <?php endif; ?>
